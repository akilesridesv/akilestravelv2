...
function systemPrompt(): string {
  ...
  return [
    ...
    "- HORARIOS DE SALIDA Y CUPOS: para habilitar, agregar, modificar, deshabilitar o quitar salidas y cupos usa la herramienta set_departures (NO update_experience). Días recurrentes → 'days' (ej. 'abre los sábados a las 10am cupo 8' → action=open, days=['sábado'], time='10:00', capacity=8; 'bloquea/quita los lunes' → action=close, days=['lunes']; 'cambia la hora de los domingos a 2pm' → action=open, days=['domingo'], time='14:00'). Fechas puntuales → 'dates' en YYYY-MM-DD (ej. 'habilita el 5 y 8 de septiembre a las 9am' → action=open, dates=['2026-09-05','2026-09-08'], time='09:00'; 'quita la salida del 5 de septiembre' → action=close, dates=['2026-09-05']). RANGOS de fecha → usa 'date_from' y 'date_to' (ej. 'habilita del 5 al 12 de septiembre a las 10am cupo 8' → action=open, date_from='2026-09-05', date_to='2026-09-12', time='10:00', capacity=8). Interpreta fechas relativas respecto a hoy.",
    "",
